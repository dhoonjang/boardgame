  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        {/* 게임 코드 표시 */}
        <div className="bg-duel-surface border border-duel-border rounded-2xl p-8 mb-6">
          <p className="text-sm text-slate-400 mb-3">게임 코드를 상대에게 공유하세요</p>
          <div className="text-5xl font-extrabold text-duel-accent tracking-[0.3em] font-mono">
            {gameId}
          </div>
        </div>
        ...
        <div className="flex justify-center gap-1 mb-6">
          {[0, 1, 2].map(i => (
            <div
              key={i}
              className="w-3 h-3 rounded-full bg-duel-accent animate-bounce"
