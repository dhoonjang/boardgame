---
description: 게임 규칙 추가/변경의 전체 라이프사이클을 진행합니다. AGENTS.md 확인 → 타입 → 로직 → 테스트 → 서버 동기화.
...
### 1단계: AGENTS.md 확인
- `packages/<game>-core/AGENTS.md`를 읽고 현재 규칙을 파악합니다.
- 사용자에게 추가/변경할 규칙을 확인합니다.

### 2단계: AGENTS.md 업데이트
- 새로운 규칙을 먼저 `AGENTS.md`에 문서화합니다.
